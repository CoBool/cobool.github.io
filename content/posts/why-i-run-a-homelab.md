...
처음 시작한 건 순전히 재미였다. 톨미 삼아 싱글보드 컴퓨터 하나를 사서 뭔가를 올려본 게 시작이었고, 그게 지금까지 이어졌다. 클라우드였다면 버튼 몇 번으로 끝날 일을, 굳이 케이스를 열고 부품을 만지고 네트워크를 잡아가며 했다. 그 과정 자체가 인프라를 몸으로 이해하는 방법이었다.
